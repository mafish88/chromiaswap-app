				...
				<div className="hp-sidebar-header-menu">
					...
					<ul>
						<li>
							...
							<ul>
								<li>
									<a href="/swap" className={page === SWAP_TOKEN_PAGE ? "active" : ""}>
										<span>
								...
								<li>
									<a href="/liquidity" className={page === ADD_LIQUIDITY_PAGE ? "active" : ""}>
										<span>
								...
								<li>
									<a href="/create" className={page === CREATE_TOKEN_PAGE ? "active" : ""}>
										<span>
								...
								<li>
									<a href="/tokens" className={page === TOKEN_LIST_PAGE ? "active" : ""}>
										<span>
